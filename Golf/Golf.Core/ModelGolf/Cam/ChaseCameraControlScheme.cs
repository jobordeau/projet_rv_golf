...
namespace BEPUphysicsDemos
{
    public class ChaseCameraControlScheme : CameraControlScheme
    {
        ...
        public ChaseCameraControlScheme(Entity chasedEntity, Vector3 offsetFromChaseTarget, bool transformOffset, float distanceToTarget, Camera camera, MiniGolf game)
            : base(camera, game)
        {
