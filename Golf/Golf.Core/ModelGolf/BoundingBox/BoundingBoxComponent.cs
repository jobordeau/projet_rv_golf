...
namespace Golf.Core.ModelGolf.BoundingBox
{
    class BoundingBoxComponent : DrawableGameComponent
    {
		...
		protected override void LoadContent()
		{
			...
			Microsoft.Xna.Framework.BoundingBox boundingBox = CreateBoundingBox(model);
		...
		private BoundingBoxBuffers CreateBoundingBoxBuffers(Microsoft.Xna.Framework.BoundingBox boundingBox, GraphicsDevice graphicsDevice)
		{
		...
		private static Microsoft.Xna.Framework.BoundingBox CreateBoundingBox(Model model)
		{
		...
		private static Microsoft.Xna.Framework.BoundingBox? GetBoundingBox(ModelMeshPart meshPart, Matrix transform)
		{
			...
			Vector3[] positions = GameObject.VertexElementExtractor.GetVertexElement(meshPart, VertexElementUsage.Position);
			if (positions == null)
				return null;
